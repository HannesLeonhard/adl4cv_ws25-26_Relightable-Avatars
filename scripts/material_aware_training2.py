...
def material_aware_training2(args, path_config, device, dataset_train, dataloader_train, debug_views, FLAMEServer):
    ## ============== Dir ==============================
    run_name = path_config.run_name
    images_save_path, images_eval_save_path, meshes_save_path, shaders_save_path, experiment_dir = make_dirs(path_config, run_name, args.finetune_color)
